...
namespace P_Automotriz1
{
    public partial class FrmVistasProductos : Form
    {
        ...
        {
            FrmCrearProductos fc = new FrmCrearProductos(this);
            fc.banderaGuardar = "guardar";
            fc.UpdateEventHandler += Fc_UpdateEventHandler;
            fc.ShowDialog();
        }
        private void Fc_UpdateEventHandler(object sender, FrmCrearProductos.UpdateEventArgs args)
        {
            CargarProductos("");
        }
        ...
        private void dtgProductos_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            fc.txtDesc.Text = dtgProductos.CurrentRow.Cells["descripción"].Value.ToString();
